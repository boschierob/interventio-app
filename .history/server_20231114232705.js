...
app.get('/delete-intervention/:customerId/:interventionId', (req, res) => {
  ...
  const client = data.customers.find(customer => customer.id === customerId);
  const interventionIndex = client.interventions.id.indexOf(interventionId)
  console.log('clientObj : ' + client);
  console.log(interventionIndex);
